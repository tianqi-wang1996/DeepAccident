...
model = dict(
    ...
    img_backbone=dict(
        ...
        pretrained='./data/DeepAccident_data/swin_small_patch4_window7_224.pth',
...
dataset_type = 'DeepAccidentDataset'
        ...
        transforms=[
            ...
            dict(
                ...
                keys=['img_inputs', 'future_egomotions', 'gt_bboxes_3d',
                      ...
                      'motion_segmentation', 'motion_instance', 'instance_centerness', 'instance_offset',
                      'instance_flow',
                      ],
